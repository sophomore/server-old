                        ...
                        def statistic_month():
                            ...
                            if len(menus) == 0:
                                ...
                                for menu in menus:
                                    ...
                                    return json.dumps(statistic.unit_menu_sum(request.form['startDate'], request.form['endDate'], menus2, request.form['unit']))
                                else:
                                    ...
                                    def print_statement():
                                        ...
                                        def file_mysql():
                                            if request.method == 'GET':
                                                ...
                                                def file_input(request.form['file']):
                                                    util.input(request.form['file'])
                                                    return json.dumps({"result":"success"})
